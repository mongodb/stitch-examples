...
Edit `index.html` in this directory, and change the line `var MY_APP_ID = "..."` so that it contains the ID of the app you created earlier (app ID is on the app's home page).
