  ...
  <div style={styles.thumbnailContainer}>
    <a href={props.imageUrl} target="_blank" alt={props.imageRecognitionData}>
      <img
        ...
        src={props.imageUrl}
        alt={props.imageRecognitionData}
        title={props.imageRecognitionData}
      />
      <p style={styles.imageDescription}>
        {props.imageRecognitionData}
      </p>
    </a>
  </div>;
...
const Header = props =>
  <div style={styles.headerContainer}>
    ...
    <div style={styles.date}>
      {dateFns.format(props.date, "DD MMMM YYYY")}
    </div>
  </div>;
...
const ReviewItem = props =>
  <div style={styles.container}>
    ...
    <div style={{ display: "flex" }}>
      {props.imageUrl && <ThumbnailContainer {...props} />}
